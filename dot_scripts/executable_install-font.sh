#!/bin/bash
#
# install-font.sh is copyright ©2024 Peter Schaffter and issued
# under the GNU General Public License, a full copy of which can be
# had at http://www.gnu.org/licenses/gpl.html
#
set -e
set -o posix
...
"gropdf found.\nInstalling \033[33m${groff_font}\033[0m in ${site_font_devpdf}/... "
        ...
        [ -e ${site_font_devpdf}/download ] || {
          touch ${site_font_devpdf}/download && chmod 666 ${site_font_devpdf}/download
        }
